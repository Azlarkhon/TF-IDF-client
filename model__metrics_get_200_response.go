...
// checks if the MetricsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricsGet200Response{}

// MetricsGet200Response struct for MetricsGet200Response
type MetricsGet200Response struct {
	Data *ModelsMetric `json:"data,omitempty"`
...
// SetData gets a reference to the given ModelsMetric and assigns it to the Data field.
...
func (o MetricsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MetricsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMetricsGet200Response struct {
	value *MetricsGet200Response
	isSet bool
}

func (v NullableMetricsGet200Response) Get() *MetricsGet200Response {
	return v.value
}

func (v *NullableMetricsGet200Response) Set(val *MetricsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricsGet200Response(val *MetricsGet200Response) *NullableMetricsGet200Response {
	return &NullableMetricsGet200Response{value: val, isSet: true}
}

func (v NullableMetricsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
