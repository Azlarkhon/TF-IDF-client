...
// checks if the ModelsDocument type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsDocument{}

// ModelsDocument struct for ModelsDocument
type ModelsDocument struct {
	CreatedAt *string `json:"created_at,omitempty"`
	Id *int32 `json:"id,omitempty"`
	// имя файла или произвольное название
...
func (o ModelsDocument) MarshalJSON() ([]byte, error) {
...
func (o ModelsDocument) ToMap() (map[string]interface{}, error) {
...
type NullableModelsDocument struct {
	value *ModelsDocument
	isSet bool
}

func (v NullableModelsDocument) Get() *ModelsDocument {
	return v.value
}

func (v *NullableModelsDocument) Set(val *ModelsDocument) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsDocument) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsDocument) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsDocument(val *ModelsDocument) *NullableModelsDocument {
	return &NullableModelsDocument{value: val, isSet: true}
}

func (v NullableModelsDocument) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsDocument) UnmarshalJSON(src []byte) error {
	v.isSet = true
