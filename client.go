...
// APIClient manages communication with the TF-IDF counter API API v1.2.0
...
type APIClient struct {
	...
	UploadDocumentAPI *UploadDocumentAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UploadDocumentAPI = (*UploadDocumentAPIService)(&c.common)
